...
import type {
  User, UserData, UserPatch, UserQuery, UserService
} from './users.class';
...
export const userPath = 'usersService';

export const userMethods = ['find', 'get', 'create', 'patch', 'remove', 'channel', 'patchEmail', 'kickUser'] as const;
